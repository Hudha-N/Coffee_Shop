...
const IcedCoffee = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/coffees?category_id=4")
    ...
    <div>
      ...
      <div className={styles.headerSection}>
        <nav className={styles.breadcrumbNav}>
          ...
          <span className={styles.breadcrumbCurrent}>Iced Coffees</span>
        </nav>

        <h2 className={styles.pageTitle}>Iced Coffees</h2>
        ...
        <div className={styles.searchWrapper}>
          <MeltyInput
            ...
            placeholder="Search icedo types…"
            width="300px"
            height="36px"
            radius={18}
          />
      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          {filteredCoffees.length > 0 ? (
            ...
            <p className={styles.noResults}>No iced coffees found</p>
          )}
        </div>
      </div>
    </div>
