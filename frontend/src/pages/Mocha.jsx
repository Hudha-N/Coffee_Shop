...
const Mocha = () => {
 ...
 const userId = 1; // Replace with actual logged-in user id
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/coffees?category_id=5")
   ...
   <div>
      ...
      <div className={styles.headerSection}>
        <nav className={styles.breadcrumbNav}>
          ...
          <span className={styles.breadcrumbCurrent}>Mocha Coffees</span>
        </nav>

        <h2 className={styles.pageTitle}>Mocha Coffees</h2>
        ...
        <div className={styles.searchWrapper}>
          <MeltyInput
            ...
            placeholder="Search mocha types…"
            width="300px"
            height="36px"
            radius={18}
          />
      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          {filteredCoffees.length > 0 ? (
            ...
            <p className={styles.noResults}>No mocha coffees found</p>
          )}
        </div>
      </div>
    </div>
