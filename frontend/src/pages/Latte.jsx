...
const Latte = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/coffees?category_id=2")
    ...
    <div>
     ...
     <div className={styles.headerSection}>
             <nav className={styles.breadcrumbNav}>
               ...
               <span className={styles.breadcrumbCurrent}>Latte Coffees</span>
             </nav>

             <h2 className={styles.pageTitle}>Latte Coffees</h2>
             ...
             <div className={styles.searchWrapper}>
               <MeltyInput
                 ...
                 placeholder="Search latte types…"
                 width="300px"
                 height="36px"
                 radius={18}
               />
      ...
      <div className={styles.grid}>
        ...
        <p className={styles.noResults}>No latte coffees found</p>
      )}
      </div>
      </div>
    </div>
