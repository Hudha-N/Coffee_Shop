...
const Americano = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/coffees?category_id=6")
     ...
     <div>
        ...
        <div className={styles.headerSection}>
          <nav className={styles.breadcrumbNav}>
            ...
            <span className={styles.breadcrumbCurrent}>Americano Coffees</span>
          </nav>
  
          <h2 className={styles.pageTitle}>Americano Coffee</h2>
          ...
          <div className={styles.searchWrapper}>
            <MeltyInput
              ...
              placeholder="Search americano types…"
              width="300px"
              height="36px"
              radius={18}
            />
        ...
        <div className={styles.container}>
          <div className={styles.grid}>
            {filteredCoffees.length > 0 ? (
              ...
              <p className={styles.noResults}>No americano coffees found</p>
            )}
          </div>
        </div>
      </div>
